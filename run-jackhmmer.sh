...
# This code is from : https://bitbucket.org/clami66/rawmsa/src/master/scripts/dataset/run_jack.sh
# Very thanks to the code Author.
# This code is a small part of paper: https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0220182#sec002
